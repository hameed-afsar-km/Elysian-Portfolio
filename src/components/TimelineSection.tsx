...
const entries = [
  ...
  },
  {
    ...
    era: "Cinematic 3D",
    headline: "FERRARI F1\nEXPERIENCE",
    sub: "Official Scuderia Ferrari 3D showcase",
    body: "Created an immersive cinematic web experience for Scuderia Ferrari HP featuring interactive 3D model visualization, dynamic audio, custom cursor physics, and telemetry animations.",
    tags: ["Next.js", "Three.js", "WebGL", "GSAP"],
    accentSide: "right" as const,
    github: "https://github.com/hameed-afsar-km/F1---Demo",
    website: "https://f1-demo-jet.vercel.app",
  },
  {
    year: "2026",
    index: "03",
    era: "Community & Web",
    headline: "CRESCENT TECH\nCLUB",
    sub: "Flagship developer community portal",
    body: "Designed and engineered the official club platform featuring interactive macOS window mockups, live event countdowns, dynamic audio integration, and member registration systems.",
    tags: ["Next.js", "Framer Motion", "Tailwind", "React"],
    accentSide: "left" as const,
    github: "https://github.com/hameed-afsar-km/CTC",
    website: "https://cres-techno-club.vercel.app",
  },
  {
    year: "2026",
    index: "04",
